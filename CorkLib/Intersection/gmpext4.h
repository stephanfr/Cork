...
namespace GMPExt4
{
	...
	inline
	std::ostream& operator<<(std::ostream &out, const GmpExt4_1 &ext)
	{
		return out << '[' << ext.e0
				   << ',' << ext.e1
				   << ',' << ext.e2
	...
	inline
	std::ostream& operator<<(std::ostream &out, const GmpExt4_2 &ext)
	{
		return out << '[' << ext.e01
				   << ',' << ext.e02
				   << ',' << ext.e03
	...
	inline
	std::ostream& operator<<(std::ostream &out, const GmpExt4_3 &ext)
	{
		return out << '[' << ext.e012
				   << ',' << ext.e013
				   << ',' << ext.e023
