...
//	using namespace FixInt;
	...
	template<int Nlhs, int Nrhs>
	inline
	void inner(typename FixInt::BitInt<(Nlhs + Nrhs + 2)>::Rep&			out,
			   const FixExt4_1<Nlhs>&							lhs,
			   const FixExt4_1<Nrhs>&							rhs)
	{
		typename FixInt::BitInt<(Nlhs + Nrhs)>::Rep p0;      mul(p0, lhs.e0, rhs.e0);
		typename FixInt::BitInt<(Nlhs + Nrhs)>::Rep p1;      mul(p1, lhs.e1, rhs.e1);
		typename FixInt::BitInt<(Nlhs + Nrhs)>::Rep p2;      mul(p2, lhs.e2, rhs.e2);
		typename FixInt::BitInt<(Nlhs + Nrhs)>::Rep p3;      mul(p3, lhs.e3, rhs.e3);
		typename FixInt::BitInt<(Nlhs + Nrhs + 1)>::Rep a;   add(a, p0, p1);
		typename FixInt::BitInt<(Nlhs + Nrhs + 1)>::Rep b;   add(b, p2, p3);
		add(out, a, b);
	}
	
	template<int Nlhs, int Nrhs>
	inline
	void inner(typename FixInt::BitInt<(Nlhs + Nrhs + 3)>::Rep&			out,
			   const FixExt4_2<Nlhs>&							lhs,
			   const FixExt4_2<Nrhs>&							rhs)
	{
		typename FixInt::BitInt<(Nlhs + Nrhs)>::Rep p0;      mul(p0, lhs.e01, rhs.e01);
		typename FixInt::BitInt<(Nlhs + Nrhs)>::Rep p1;      mul(p1, lhs.e02, rhs.e02);
		typename FixInt::BitInt<(Nlhs + Nrhs)>::Rep p2;      mul(p2, lhs.e03, rhs.e03);
		typename FixInt::BitInt<(Nlhs + Nrhs)>::Rep p3;      mul(p3, lhs.e12, rhs.e12);
		typename FixInt::BitInt<(Nlhs + Nrhs)>::Rep p4;      mul(p4, lhs.e13, rhs.e13);
		typename FixInt::BitInt<(Nlhs + Nrhs)>::Rep p5;      mul(p5, lhs.e23, rhs.e23);
		typename FixInt::BitInt<(Nlhs + Nrhs + 1)>::Rep a;   add(a, p0, p1);
		typename FixInt::BitInt<(Nlhs + Nrhs + 1)>::Rep b;   add(b, p2, p3);
		typename FixInt::BitInt<(Nlhs + Nrhs + 1)>::Rep c;   add(c, p4, p5);
		typename FixInt::BitInt<(Nlhs + Nrhs + 2)>::Rep x;   add(x, a, b);
		add(out, x, c);
	}
	...
	void inner( typename FixInt::BitInt<(Nlhs + Nrhs + 2)>::Rep&		out,
			    ...
			    const FixExt4_3<Nrhs>&							rhs)
	{
		typename FixInt::BitInt<(Nlhs + Nrhs)>::Rep p0;      mul(p0, lhs.e012, rhs.e012);
		typename FixInt::BitInt<(Nlhs + Nrhs)>::Rep p1;      mul(p1, lhs.e013, rhs.e013);
		typename FixInt::BitInt<(Nlhs + Nrhs)>::Rep p2;      mul(p2, lhs.e023, rhs.e023);
		typename FixInt::BitInt<(Nlhs + Nrhs)>::Rep p3;      mul(p3, lhs.e123, rhs.e123);
		typename FixInt::BitInt<(Nlhs + Nrhs + 1)>::Rep a;   add(a, p0, p1);
		typename FixInt::BitInt<(Nlhs + Nrhs + 1)>::Rep b;   add(b, p2, p3);
		add(out, a, b);
	}
