...
namespace Ext4
{
	...
	inline
	void neg(Ext4_1 &out, const Ext4_1 &in)
	{
		for(int i=0; i<4; i++)
		{
			out.v[i] = -in.v[i];
	...
	inline
	void neg(Ext4_2 &out, const Ext4_2 &in)
	{
		for(int i=0; i<6; i++)
		{
			out.v[i] = -in.v[i];
	...
	inline
	void neg(Ext4_3 &out, const Ext4_3 &in)
	{
		for(int i=0; i<4; i++)
		{
			out.v[i] = -in.v[i];
	...
	inline
	void dual(Ext4_1 &out, const Ext4_3 &in)
	{
		out.e0 =  in.e123;
		out.e1 = -in.e023;
		out.e2 =  in.e013;
	...
	inline
	void dual(Ext4_2 &out, const Ext4_2 &in)
	{
		out.e01 =  in.e23;
		out.e02 = -in.e13;
		out.e03 =  in.e12;
	...
	inline
	void dual(Ext4_3 &out, const Ext4_1 &in)
	{
		out.e012 =  in.e3;
		out.e013 = -in.e2;
		out.e023 =  in.e1;
	...
	inline
	void revdual(Ext4_1 &out, const Ext4_3 &in)
	{
		out.e0 = -in.e123;
		out.e1 =  in.e023;
		out.e2 = -in.e013;
	...
	inline
	void revdual(Ext4_2 &out, const Ext4_2 &in)
	{
		out.e01 =  in.e23;
		out.e02 = -in.e13;
		out.e03 =  in.e12;
	...
	inline
	void revdual(Ext4_3 &out, const Ext4_1 &in)
	{
		out.e012 = -in.e3;
		out.e013 =  in.e2;
		out.e023 = -in.e1;
	...
	inline
	void join(Ext4_2 &out, const Ext4_1 &lhs, const Ext4_1 &rhs)
	{
	...
	inline
	void join(Ext4_3 &out, const Ext4_2 &lhs, const Ext4_1 &rhs)
	{
	...
	inline
	void join(Ext4_3 &out, const Ext4_1 &lhs, const Ext4_2 &rhs)
	{
		join(out, rhs, lhs);
	...
	inline
	void meet(Ext4_2 &out, const Ext4_3 &lhs, const Ext4_3 &rhs)
	{
		Ext4_2 out_dual;
		Ext4_1 lhs_dual;
		Ext4_1 rhs_dual;
	...
	inline
	void meet(Ext4_1 &out, const Ext4_2 &lhs, const Ext4_3 &rhs)
	{
		Ext4_3 out_dual;
		Ext4_2 lhs_dual;
		Ext4_1 rhs_dual;
	...
	inline
	void meet(Ext4_1 &out, const Ext4_3 &lhs, const Ext4_2 &rhs)
	{
		Ext4_3 out_dual;
		Ext4_1 lhs_dual;
		Ext4_2 rhs_dual;
	...
	inline
	double inner(const Ext4_1 &lhs, const Ext4_1 &rhs)
	{
		double acc = 0.0;
	...
	inline
	double inner(const Ext4_2 &lhs, const Ext4_2 &rhs)
	{
		double acc = 0.0;
	...
	inline
	double inner(const Ext4_3 &lhs, const Ext4_3 &rhs)
	{
		double acc = 0.0;
