...
namespace Cork::AbsExt4
{
    struct AbsExt4_1
    {
        ...
        explicit AbsExt4_1(const Ext4::Ext4_1 &element)
            : e0(fabs(element.e0())), e1(fabs(element.e1())), e2(fabs(element.e2())), e3(fabs(element.e3()))
        {
        }



        AbsExt4_1(double e0__, double e1__, double e2__, double e3__) : e0(e0__), e1(e1__), e2(e2__), e3(e3__) {}
    ...
    struct AbsExt4_3
    {
        AbsExt4_1 dual() const { return AbsExt4_1(e123, e023, e013, e012); }
    ...
    //		inline void abs(AbsExt4_1 &out, const Ext4::Ext4_1 &in)
    //		{
    //			for(int i=0; i<4; i++)
    //			{
    //				out.v[i] = fabs(in[i]);
    ...
    inline AbsExt4_1 operator() ( const Ext4_1&     ext_to_convert )
    {
        return AbsExt4_1( fabs( ext_to_convert.e0(), ext_to_convert.e1(), ext_to_convert.e2() ) );
    }

    inline void abs(AbsExt4_2 &out, const Ext4::Ext4_2 &in)
    {
        for (int i = 0; i < 6; i++)
        {
            out.v[i] = fabs(in[i]);
    ...
    inline void abs(AbsExt4_3 &out, const Ext4::Ext4_3 &in)
    {
        for (int i = 0; i < 4; i++)
        {
            out.v[i] = fabs(in[i]);
    ...
    inline void join(AbsExt4_3 &out, const AbsExt4_1 &lhs, const AbsExt4_2 &rhs) { join(out, rhs, lhs); }
    ...
    inline void meet(AbsExt4_2 &out, const AbsExt4_3 &lhs, const AbsExt4_3 &rhs)
    {
        ...
        AbsExt4_1 lhs_dual( lhs.dual() );
        AbsExt4_1 rhs_dual( rhs.dual() );
