	...
	namespace AABVH
	{
		...
		public:
			...
			{ 
				...
				unsigned int			blobIDListSelector = std::to_integer<unsigned int>( intersectionType == IntersectionType::BOOLEAN_INTERSECTION ? triangle.boolAlgData() ^ std::byte{1} : triangle.boolAlgData());
		...
		private:
			...
			Xoroshiro256Plus							random_number_generator_;
