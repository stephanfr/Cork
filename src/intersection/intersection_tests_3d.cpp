...
namespace Cork::Empty3d
{
    ...
    HasIntersection TriangleTriangleTriangleIntersection::hasIntersection(ExactArithmeticContext& context) const
    {
        ...
        std::array<Ext4_3, 3> t_ext3s;              //  NOLINT(cppcoreguidelines-pro-type-member-init)
    ...
    {
        std::array<std::array<AbsExt4_1, 3>, 3> kp;                 //  NOLINT(cppcoreguidelines-pro-type-member-init)
        std::array<Ext4_3, 3> t;                                    //  NOLINT(cppcoreguidelines-pro-type-member-init)
        std::array<AbsExt4_3, 3> kt;                                //  NOLINT(cppcoreguidelines-pro-type-member-init)
    ...
    HasIntersection TriangleTriangleTriangleIntersection::exactFallback(const Math::Quantizer& quantizer, ExactArithmeticContext& context) const
    {
        ...
        std::array<std::array<FixExt4_1<FIXED_INTEGER_BITS>, 3>, 3> p;          //  NOLINT(cppcoreguidelines-pro-type-member-init)
        std::array<FixExt4_3<EXT3_UP_BITS>, 3> t;                               //  NOLINT(cppcoreguidelines-pro-type-member-init)
