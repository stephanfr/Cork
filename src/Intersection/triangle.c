...
//	SEF
//
//	I replaced 'unsigned long' with 'uintptr_t' throughout the code to
//		resolve Win64 issues wherein unsigned long is not 64 bits
//		in 64 bit windows.
//
//	I changed the printf variadic argument for uintptr_t to 'llx' to
